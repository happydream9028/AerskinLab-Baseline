...
window['ThemeComponent_Video'] = function (id, type, host, autoplay = true) {
  return {
    enabled: false,
    id: id,
    type: type,
    ...
    mounted: function mounted() {
      ...
      this.enableVideo();
      setTimeout(() => {
        const videoDom = this.$refs.video_container.querySelector('.video');
        videoDom.muted = true;
        videoDom.play();
      },10);
 ...
 */
 ...
 register('faq-accordion', {
  onLoad: function onLoad() {
    console.log("df");
    this.sectionId = this.id;
    var accordions = this.container.querySelectorAll('[data-faq-accordion]');
    var accordionOpen = {};

    for (var i = 0; i < accordions.length; i++) {
      accordionOpen['faq-accordion' + i] = false;
    }
